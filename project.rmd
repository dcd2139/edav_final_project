...
As part of this project, we would like to study the racial distribution of population in New York City to help answer the following questions:
...
Observations from Choropleth maps By Zipcodes:
 ...
 - High concentration of black population can be noticed in neighborhoods in southern Brookyln, sourthern queens, 
